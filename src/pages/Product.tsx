...
const Product: FC = () => {
  ...
  return (
    <>
      <Breadcrumbs title={currentProduct?.title} />
            ...
            {status === "success" && (
              <div className="product__wrapper">
                ...
                <div className="product__info">
                  <span className="product__availability">В наличии</span>
                  ...
                  <p className="product__volume">
                    <img
                      src={bottle}
                      alt=""
                      className="product__volume-img product__volume-img--bottle"
                    />
                    {currentProduct?.size}
                  </p>
                  ...
                  <div className="product__extra">
                    <button className="product__share-btn">
                      <img
                        src={share}
                        alt="Поделиться в соцсетях"
                        className="product__share-img"
                      />
                    </button>
                    <div className="product__extra-delivery-wrapper">
                      <p className="product__extra-delivery">
                        При покупке от <span>10 000 ₸ </span>бесплатная доставка
                  ...
                  <div className="product__data">
                    <p className="product__data-row">
                      <span className="product__data-name">Производитель:</span>
                      <span className="product__data-value">
                        {currentProduct?.producer}
                      </span>
                    </p>
                    <p className="product__data-row">
                      <span className="product__data-name">Бренд:</span>
                      <span className="product__data-value">
                        {currentProduct?.brand}
                      </span>
                    </p>
                    <p className="product__data-row">
                      <span className="product__data-name">Артикул:</span>
                      <span className="product__data-value">460404</span>
                    </p>
                    <p className="product__data-row">
                      <span className="product__data-name">Штрихкод:</span>
                      <span className="product__data-value">
                        {currentProduct?.barcode}
                      </span>
                    </p>
                  </div>
                  <details className="product__descr">
                    <summary className="product__descr-title">Описание</summary>
                    <p className="product__details-text">
                      {currentProduct?.description}
                    </p>
                  </details>
                  <details className="product__descr">
                    <summary className="product__descr-title">
                      Характеристики
                    </summary>
                    <div className="product__details">
                      <p className="product__data-row">
                        <span className="product__data-name">Назначение:</span>
                        <span className="product__data-value">BioMio</span>
                      </p>
                      <p className="product__data-row">
                        <span className="product__data-name">Тип:</span>
                        <span className="product__data-value">BioMio</span>
                      </p>
                      <p className="product__data-row">
                        <span className="product__data-name">
                          Производитель:
                        </span>
                        <span className="product__data-value">
                          {currentProduct?.producer}
                      ...
                      <p className="product__data-row">
                        <span className="product__data-name">
                          {currentProduct?.sizeType === "weight"
                            ? "Вес"
                            : "Объем"}
                          :
                        </span>
                      ...
                      <p className="product__data-row">
                        <span className="product__data-name">Объем:</span>
                        <span className="product__data-value">90 г</span>
                      </p>
                      <p className="product__data-row">
                        <span className="product__data-name">
                          Кол-во в коробке:
                        </span>
                        <span className="product__data-value">10</span>
                      </p>
                    </div>
                  </details>
                </div>
