          ...
          <div className="product__wrapper">
            ...
            <div className="product__info">
              ...
              <h2 className="product__title">
                <span className="product__title-name">BioMio BIO-SOAP </span>
              ...
              <div className="product__cart-block">
                <div className="product__price">48,76 ₸</div>
              ...
              <div className="product__data">
                ...
                <p className="product__data-row">
                  ...
                  <span className="product__data-value">4604049097548</span>
                </p>
              </div>
              ...
              <details className="product__descr">
                ...
                <div className="product__details">
                  ...
                  <p className="product__data-row">
                    <span className="product__data-name">Вес:</span>
