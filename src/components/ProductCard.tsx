      ...
      <div className="card">
        ...
        <div className="card__content">
          ...
          <div className="card__row-wrapper">
            ...
            <span className="card__row-value">4604049097548</span>
          </div>
          <div className="card__row-wrapper">
            <span className="card__row-name">Производитель:</span>
            <span className="card__row-value">Нэфис</span>
          </div>
          <div className="card__row-wrapper">
            <span className="card__row-name">Бренд:</span>
            <span className="card__row-value">AOS</span>
          </div>
        </div>
        <div className="card__bottom">
          <div className="card__price">48,76 ₸</div>
